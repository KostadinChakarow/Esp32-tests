 ...
 * GPIO5:  input, pulled up, interrupt from rising edge.
 # Adding some more inputs/outputs
 # OUTPUTS 
 * GPI0 16: output
 * GPIO 17: output
 # INPUTS
...
//Set change GPIO register for pin 16/17 as outputs
#define GPIO_OUTPUT_PIN_SEL ((1ULL << GPIO_OUTPUT_IO_2) | (1ULL << GPIO_OUTPUT_IO_3))
//Inputs - map
#define GPIO_INPUT_IO_2     2
#define GPIO_INPUT_IO_3     3
//Set change GPIO register for pin 16/17 as inputs
...
void app_main(void)
{
    ...
    //hook more isr handler for specific gpio pin
